...
import com.commander4j.settings.JLicenseInfo;
...
public class JDialogDisplayLicense extends JDialog
{
	...
	public JDialogDisplayLicense(JDialogLicenses lll, JLicenseInfo license)
	{
		...
		setBounds(screenBounds.x + ((screenBounds.width - JDialogDisplayLicense.this.getWidth()) / 2), screenBounds.y + ((screenBounds.height - JDialogDisplayLicense.this.getHeight()) / 2),
				JDialogDisplayLicense.this.getWidth() + widthadjustment, JDialogDisplayLicense.this.getHeight() + heightadjustment);
	}
