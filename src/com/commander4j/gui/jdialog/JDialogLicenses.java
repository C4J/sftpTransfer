...
public class JDialogLicenses extends JDialog
{
	...
	public JDialogLicenses(JFrame frame)
	{
		...
		JLabel4j_std lblNewLabel = new JLabel4j_std(padRight("Library", JLicenseInfo.width_description) + padRight("Version", JLicenseInfo.width_version) + "Licence");
